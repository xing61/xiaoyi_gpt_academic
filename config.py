...
API_KEY = "此处填智增增的API密钥"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://flag.smarttrot.com/v1/chat/completions"}
...
# 自定义API KEY格式
CUSTOM_API_KEY_PATTERN = "此处填智增增的API密钥"
